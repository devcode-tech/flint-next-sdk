      ...
      <div className="container mx-auto px-4">
        <div className="mb-8 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            This is a live demonstration of the Dynamic Form SDK. The form below is generated 
            entirely from a JSON schema, with full validation, styling, and submission handling.
          </p>
        </div>
